 ...
 * @author Mina
 */
public class ZakasniliPonovniTestKorisniciSO extends  OpstaSistemskaOperacija{
    ...
    public ServerskiOdgovor izvrsiKonkretnuOperaciju(IOpstiDomenskiObjekat odo) throws Exception {
        List<IOpstiDomenskiObjekat> rez = DBBroker.getInstance().zakasniliPonovniTestSamoproceneKorisnici();        
